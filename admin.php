            ...
            <div class="header-top">
                <div class="container">
                    <div class="row">
                        ...
                        <a  href="adminReg.php" button type="button" class="btn btn-primary" style="width: 10%; height: 5%; margin-top: 3%; margin-right: 3%; margin-left: 3%;">Register Admin</button></a>
                        <!-- /Block search module TOP -->
